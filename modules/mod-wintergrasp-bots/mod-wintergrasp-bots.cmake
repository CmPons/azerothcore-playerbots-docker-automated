if(TARGET modules)
  ...
  if(EXISTS "${_PB_SRC}")
    target_include_directories(modules PRIVATE
      ...
      ${_PB_SRC}/Script
      ${_PB_SRC}/Ai/Base)
    message(STATUS "[mod-wintergrasp-bots] mod-playerbots headers on include path")
  else()
    message(WARNING "[mod-wintergrasp-bots] mod-playerbots not found; build will fail until it is cloned")
  endif()
endif()
